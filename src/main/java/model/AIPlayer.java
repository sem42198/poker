...
public class AIPlayer extends Player {
     ...
     * @param hand        The type of hand the player has
     * @param  perc       Impacts likelihood of betting
     * @return            The turn that the AI should take
     */
    public Turn getTurn(int minBet, int maxBet, Card[] boardCards,
        HandType hand, double perc) {
    ...
    public Turn getTurn(int minBet, int maxBet, Card[] boardCards,
        HandType hand) {
        return this.getTurn(minBet, maxBet, boardCards, hand, 0);
    }
